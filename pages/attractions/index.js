...
// import TourProperties from "../../components/attraction-list/tour-list-v2/TourProperties";
import TopHeaderFilter from "../../components/attraction-list/tour-list-v2/TopHeaderFilter";
...
import MainFilterSearchBox from "../../components/attraction-list/tour-list-v1/MainFilterSearchBox";
import {
  useAttractionFilterStore,
  useAttractionPaginationStore,
} from "../../lib/store";
import React from "react";
import AttractionProperties from "../../components/attraction-list/tour-list-v2/AttractionProperties";
        ...
        <div className="container">
          <div className="row y-gap-30">
            ...
            <div className="col-xl-9 ">
              ...
              {/* End mt--30 */}
              <div className="row y-gap-30">
                <AttractionProperties filter={filter} setFilter={setFilter} />
              </div>
              {/* End .row */}
              <Pagination
